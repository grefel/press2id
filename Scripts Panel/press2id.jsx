...
function getConfig(newConfigObject) {
    ...
    function createModePanel() {
        ...
        var grpPlaceGun = group6.add("group");
        ...
        var imagePlaceGun = group6.add("image", undefined, File.decode(image1_imgString), { name: "image1" });
        ...
        var stTemplate = group9.add("statictext", undefined, "Musterseite zur Platzierung verwenden");
        ...
        var imageTemplate = group9.add("image", undefined, File.decode(image2_imgString), { name: "image2" });
        ...
        var staticDatabase = group12.add("statictext", undefined, "Vorbereitete Datenfelder befüllen");
        ...
        var imageDatabase = group12.add("image", undefined, File.decode(image3_imgString), { name: "image3" });
        ...
        stPlaceGun.addEventListener('mousedown', placeGunMode);
        imagePlaceGun.addEventListener('mousedown', placeGunMode);
        ...
        stTemplate.addEventListener('mousedown', templateMode);
        imageTemplate.addEventListener('mousedown', templateMode);
        ...
        imageDatabase.addEventListener('mousedown', databaseMode);
        staticDatabase.addEventListener('mousedown', databaseMode);
    ...
    if (!dok.saved) {
        if (log.confirm("Das Dokument muss zuerst gespeichert werden!\rSpeichern und fortfahren?", undefined, "Dokument ist nicht gespeichert")) {
            try {
                ...
                dok = dok.save();
                px.documentFolder = dok.fullName;
            } catch (e) {
