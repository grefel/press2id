...
var configObject = {
    ...
    loadImagesToPlaceGun: true, // if false, the images are placed into the text flow    
            ...
            for (var s = 0; s < listboxSelectPost.selection.length; s++) {
                ...
                if (listboxSelectPost.selection[s].toString().indexOf(listItems[p].blogTitle + " [" + listItems[p].id + "]") == 0) {
                    selectedPostsArray.push({
                        ...
                        downloadImages: configObject.downloadImages,
                        localImageFolder: configObject.localImageFolder,
                        blogURL: configObject.restURL,
