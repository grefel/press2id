...
function main() {
    ...
    if (historyConfigObject != "") {
        ...
        configObject = JSON.parse(historyConfigObject);
    ...
    $.writeln(JSON.stringify(configObject));
}
...
function getConfig(newConfigObject) {
    ...
    function createGetUrlPanel() {
        ...
        infoArea.preferredSize.height = 50;
        infoArea.text = "";
    ...
    function createModePanel() {
        ...
        var rbPlaceGun = group5.add("radiobutton", undefined, undefined, { name: "singlePost" });
        ...
        group6.preferredSize.width = 480;
        group6.orientation = "column";
        group6.alignChildren = ["left", "center"];
        group6.spacing = 6;
        group6.margins = 0;

        var statictext2 = group6.add("group");
        statictext2.orientation = "column";
        statictext2.alignChildren = ["left", "center"];
        statictext2.spacing = 0;

        statictext2.add("statictext", undefined, "Beiträge in die Platzierungs-Einfügemarke", { name: "statictext2" });
        statictext2.add("statictext", undefined, "laden", { name: "statictext2" });
        ...
        var image1 = group6.add("image", undefined, File.decode(image1_imgString), { name: "image1" });
        image1.helpTip = "Wähle einen Wordpress Beitrag.\nText und Bilder können mit der Platzierungs-­Einfügemarke in das aktive Dokument  eingefügt werden.";

        var statictext3 = group6.add("group");
        ...
        statictext3.add("statictext", undefined, "Text und Bilder werden in die Platzierungs-Einfügemarke geladen.", { name: "statictext3" });
        ...
        group9.preferredSize.width = 480;
        ...
        statictext4.text = "Musterseite zur Platzierung  verwenden";
        ...
        var image2 = group9.add("image", undefined, File.decode(image2_imgString), { name: "image2" });

        var statictext5 = group9.add("group");
        ...
        group12.preferredSize.width = 480;
        group12.orientation = "column";
        group12.alignChildren = ["left", "center"];
        group12.spacing = 10;
        group12.margins = 0;

        var statictext6 = group12.add("statictext", undefined, undefined, { name: "statictext6" });
        statictext6.text = "Vorbereitete Datenfelder befüllen";
        ...
        var image3 = group12.add("image", undefined, File.decode(image3_imgString), { name: "image3" });

        var statictext7 = group12.add("group");
    ...
    function createFilterPanel() {
        ...
        st.text = "Es wurden nur die neuesten 100 Einträge geladen";
        ...
        buttonFilter.onClick = function () {
            st.text = "Es wurden alle vorhandenen Einträge geladen";
            loadMaxPages = 50;
            listItems = getListOfBlogEntries(newConfigObject.restURL, loadMaxPages, false, newConfigObject.endPoint, newConfigObject.filterBeforeDate, newConfigObject.filterAfterDate);
            fillListboxSelectPost(listItems);
        }
    ...
    function fillListboxSelectPost(localListItems) {
        ...
        for (var i = 0; i < localListItems.length; i++) {
            if (etPostFilter.text == ui.panelSelectPostFilter) {
                tempArray.push(localListItems[i].blogTitle + " [" + localListItems[i].id + "]");
            }
            else if ((localListItems[i].blogTitle + "").toLowerCase().match(tempMatcher)) {
                tempArray.push(localListItems[i].blogTitle + " [" + localListItems[i].id + "]");
            }
        }
